...
- [ ] ☁️ 5 > [Create a simple serverless API on AWS](Journey/005/Readme.md)
- [ ] ☁️ 6 > [Create a FileShare on Azure](Journey/006/Readme.md)
- [ ] ☁️ 7 > [Create an Aurora RDS Database](Journey/007/Readme.md)
